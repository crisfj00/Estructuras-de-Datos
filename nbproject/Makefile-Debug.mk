...
${OBJECTDIR}/src/vector_dinamico.o: src/vector_dinamico.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -include include/ingrediente.h -include include/ingredientes.h -include include/vector_dinamico.h -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vector_dinamico.o src/vector_dinamico.cpp
